...
def main():
	...
	midiSong = open('./songs/' + name + ".txt","w")
	midiSong.write("playback_speed=1.0\n")
	for l in midi.notes:
		midiSong.write(str(l[0]) + " " + str(l[1]) + "\n")
